...
% fprintf ( 1, '  Generating an anonymized (blurred) version of the data.\n' );

% Generates an anonymazed anatomy by blurring the original data.
mriblur      = imgaussfilt3 ( mri.anatomy, 30 );

% Replaces the face by the blurred version.
mri.anatomy ( facemask ) = mriblur ( facemask );
